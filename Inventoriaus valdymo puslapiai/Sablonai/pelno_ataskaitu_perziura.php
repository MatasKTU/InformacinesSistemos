...
// Funkcija nuskaityti ataskaitas iš CSV
...
<head>
    ...
    <title>Pelno ataskaitų peržiūra</title>
...
<div class="container mt-5">
    <h1>Pelno ataskaitų peržiūra</h1>

    <!-- Ataskaitų pasirinkimas -->
    <form method="POST">
        <ul class="list-group">
    ...
    <?php elseif ($selectedAtaskaita): ?>
        <p class="text-danger">Ataskaita nerasta.</p>
    <?php endif; ?>
</div>
</body>
</html>
